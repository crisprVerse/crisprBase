...
called the Protospacer Flanking Sequence (PFS).
...
respect to the PAM or PFS sequence. The `spacer_length` specified a default
spacer length, and the `spacer_gap` specifies a distance (in nucleotides)
between the PAM (or PFS) sequence and spacer sequence.
...
```{r, echo=FALSE, fig.cap="Examples of DNA-targeting CRISPR nucleases"}
...
## Considerations for RNA-targeting CRISPR nucleases
