...
The `Nuclease` class has 4 fields: `nucleaseName`, `metadata`, `motifs`
and `weights`. The `nucleaseName` and `metadata` fields specify a name for the
...
SpCas9 <- CrisprNuclease("SpCas9",
                         ...
                         metadata="Wildtype Streptococcus pyogenes Cas9 (SpCas9)
                                  nuclease",
                         spacer_side="5prime",
                         spacer_length=20)
SpCas9
...
SaCas9 <- CrisprNuclease("SaCas9",
                         pams=c("(3/3)NNGRRT"),
                         metadata="Wildtype Staphylococcus aureus Cas9 (SaCas9)
                                  nuclease",
                         spacer_side="5prime",
                         spacer_length=21)
SaCas9
...
AsCas12a <- CrisprNuclease("AsCas12a",
                           pams="TTTV(18/23)",
                           metadata="Wildtype Acidaminococcus Cas12a (AsCas12a)
                                    nuclease.",
                           spacer_side="3prime",
                           spacer_length=23)
AsCas12a
