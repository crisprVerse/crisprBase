...
`crisprBase` can be installed from Bioconductor by typing the
...
The complete documentation for the package can be found [here](https://bioconductor.org/packages/devel/bioc/manuals/crisprBase/man/crisprBase.pdf).
...
knitr::include_graphics("vignettes/figures/enzymes.svg")
```
...
knitr::include_graphics("vignettes/figures/nucleases.svg")
```
...
knitr::include_graphics("vignettes/figures/cut_sites.svg")
```
...
knitr::include_graphics("vignettes/figures/nucleasesBaseEditor.svg")
```
...
knitr::include_graphics("vignettes/figures/nickases.svg")
```
